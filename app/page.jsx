  ...
  return (
      <main className="w-full bg-[#141414] starscontainer">
        ...
        <div id="about" className="h-screen relative text-white flex items-center z-20">
          <div className="w-[90vw] sm:w-[25vw] mx-auto h-[30vw] sm:h-auto p-[2.5vw] sm:p-[1.25vw] rounded-[1vw] sm:rounded-[.5vw] text-[3.25vw] sm:text-[1.25vw] duration-200 ease-in-out bg-[#101010]">
