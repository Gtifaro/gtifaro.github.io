      ...
      <main className="w-full bg-[#141414] starscontainer">
        ...
        <div id="about" className="h-screen relative text-white flex items-center z-20">
          <div className="w-[75vw] sm:w-[29vw] mx-auto h-auto p-[2.5vw] sm:p-[1.5vw] rounded-[1vw] sm:rounded-[.5vw] text-[3.25vw] sm:text-[1.25vw] duration-200 ease-in-out bg-[#101010]">
            Desarrollador Frontend con más de 1 año de experiencia creando soluciones innovadoras con tecnologías como HTML, CSS, JavaScript, entre otras.<br/><br/> Nacido en Bogotá, Colombia, hace 21 años y apasionado por la creación del futuro de la tecnología.
          </div>
        </div>
