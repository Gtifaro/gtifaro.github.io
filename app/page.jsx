    ...
    <main className="w-full bg-[#141414]">
      <div id="home" className="h-screen text-white flex items-center">
        <div className="w-fit mx-auto">
          ...
          <span className="select-none cursor-default w-fit sm:mx-auto text-[5vw] sm:text-[2.5vw] text-left text-white block font-semibold leading-[5vw] sm:leading-[2.5vw]">{cursor}<span className={`duration-200 ${finalCursor ? "opacity-100" : "opacity-0"}`}>|</span></span>
          <div className="sm:grid sm:grid-cols-2 w-full h-auto mt-[1.75vw] sm:mt-[1vw] animate-fade-up animate-once animate-duration-700 animate-delay-[500ms] flex items-center">
            ...
            <div className="float-left w-fit sm:w-full h-auto flex items-center">
              <a href="https://www.github.com/Gtifaro" target="_blank" className="hover:scale-125 duration-200 ml-[3vw] sm:ml-[0vw] block w-[5vw] sm:w-fit sm:h-fit"><Github /></a>
              <a href="https://www.linkedin.com/in/gtifaro" target="_blank" className="hover:scale-125 duration-200 ml-[2vw] sm:ml-[1vw] block w-[5vw] sm:w-fit sm:h-fit"><Linkedin /></a>
            </div>
          </div>
        </div>
      </div>
